...
void function () {
  var cache$, compose, each, extend, filter, identity, keyReplacer, log, map, patternMatcher, Responder, ResponseSpecification, size, sortBy, stripExtension, url;
  ...
  ResponseSpecification = function () {
    function ResponseSpecification(options) {
      ...
      this.body = cache$1.body;
      this.statusCode = cache$1.statusCode;
  ...
  Responder = function () {
    ...
    Responder.prototype.respondTo = function (request) {
      ...
      each(allowedEntries, function (entry) {
        ...
        return null != statusCode ? statusCode : statusCode = entry.statusCode;
      });
      return {
    ...
    Responder.prototype._buildStaticResponseEntry = function (filename, param$) {
      var body, cache$1, cache$2, cache$3, method, path, pathname, query, statusCode;
      {
        cache$1 = param$;
        body = cache$1.body;
        statusCode = cache$1.statusCode;
      }
