  ...
  Server = function () {
    ...
    Server.prototype.run = function () {
      ...
      while (this.argv.length > 0) {
        ...
        } else if ('--api-path' === this.argv[0]) {
          this.argv.shift();
          this.options.apiPath = this.argv.shift();
        } else if ('--static-path' === this.argv[0]) {
          this.argv.shift();
          this.options.staticPath = this.argv.shift();
        } else {
    ...
    Server.prototype.start = function (done) {
      ...
      return loadFiles(this.options.apiPath, function (this$) {
